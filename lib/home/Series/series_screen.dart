...
import 'package:bestiptv/providers/serie_provider.dart';
...
class _SeriesPageState extends ConsumerState<SeriesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final serie = ref.watch(seriesProvider.notifier);
    return Scaffold(
        appBar: AppBar(
          title: Text(
            _timeString,
        ...
        body: Row(mainAxisAlignment: MainAxisAlignment.start, children: [
          Container(
            ...
            child: ListView.separated(
                ...
                itemCount: homeState.gruposSeries!.length,
                itemBuilder: (BuildContext context, int i) {
                  return GestureDetector(
                    onTap: () async {
                      t = await serie.buscarCanalGrupo(
                          homeState.gruposSeries![i].toString());
                      setState(() {
                        group = homeState.gruposSeries![i].toString();
                      });
                    },
                    child: Container(
                      height: 40,
...
Widget _filtro(BuildContext context, WidgetRef ref, List<Map<String,dynamic>> t) {
                ...
                child: Column(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: t[index]['logo'].toString().contains('http')
                            ? Image.network(t[index]['logo'].toString(),
                            fit: BoxFit.fill)
                            : Container(
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(10),
